...
When drowsiness is detected, the characteristic value is updated,
pushing a GATT notification to all subscribed phones (e.g. nRF Connect).
...
────────────
  ...
  This script (registers GATT application + advertisement)
    ↕  BLE radio
  Phone running nRF Connect

Requires: sudo (BlueZ needs root for advertising)
"""
...
class Application(dbus.service.Object):
    """Root object that contains all services."""
