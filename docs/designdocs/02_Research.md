...
### 3. Rideshare Driver Persona

**Name:** Daniel Kim  
**Age:** 29  
**Role:** Rideshare driver  
**Experience:** 3 years driving part-time and full-time shifts  
**Tech Comfort:** High  
**Primary Goal:** Stay safe, protect passengers, and maintain high ratings while maximizing earnings.  

**Background**  
Daniel drives in busy city environments with constant distractions such as navigation, passenger conversations, traffic, and frequent stops. He relies heavily on his phone and app ecosystem for work. He needs safety support that fits smoothly into a fast-paced driving routine.

**Needs**
* Instant alerts for distraction or drowsiness without interrupting navigation
* A lightweight app experience that works alongside rideshare apps
* A sense of protection for both him and his passengers
* Performance feedback that helps him improve
* Minimal hardware complexity inside the vehicle

**Pain Points**
* Urban driving creates frequent head turns and glance behavior that could be misread
* Too many alerts would be distracting and frustrating
* Passenger interactions can increase cognitive load
* He may worry about privacy, ratings, or how data is used

**Motivations**
* Keep passengers safe
* Avoid collisions and liability
* Maintain strong ratings and platform standing
* Drive longer hours safely when demand is high
* Use smart tech that helps him earn without adding stress

**How He Uses the System**
* Embedded camera and AI monitor for drowsiness, prolonged off-road gaze, and inattentive behavior
* Mobile app sends quick driver-facing notifications such as audio or visual warnings
* Serious or repeated events can be escalated to a platform manager or fleet partner if applicable
* He may review summaries after shifts to improve behavior

**What Success Looks Like for Daniel**
* Safer trips for him and his passengers
* Fewer distracted-driving moments
* Alerts that are subtle, fast, and accurate
* Better confidence during long shifts or late-night driving
* A system that feels like a co-pilot, not surveillance


## Research into existing designs and/or products
<!-- Person 2 -->
